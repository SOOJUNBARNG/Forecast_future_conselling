...
def find_best_arima_params(y, p_range=(0, 3), d_range=(0, 2), q_range=(0, 3)):
...
def arima_output():
    ...
    for clinic_id in df["clinic_id"].unique():
        ...
        # Proceed with ARIMA model fitting
        best_p, best_d, best_q = find_best_arima_params(y)
        model = ARIMA(y, order=(best_p, best_d, best_q))
